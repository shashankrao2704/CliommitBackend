"""
Django settings for cliommitPlatform project.
...
SECRET_KEY = '5!6e^rvx(tnufn2@g9b4505$ka@dilc)oen2jn@&%#=y=n3z3v'
...
ROOT_URLCONF = 'cliommitPlatform.urls'
...
WSGI_APPLICATION = 'cliommitPlatform.wsgi.application'
